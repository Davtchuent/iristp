@echo off
REM Script de lancement de l'application Streamlit Iris pour Windows
REM ==================================================================

echo.
echo ================================
echo   APPLICATION IRIS ML
echo   Classification des Fleurs
echo ================================
echo.
...
if not exist "Iris.csv" (
    echo.
    echo [ATTENTION] Le fichier Iris.csv n'est pas trouve
